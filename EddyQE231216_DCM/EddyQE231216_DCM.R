...
XCMSList <- xcmsfunction(extractiontype)
xset3 <- XCMSList[[1]]
xset.allpeaks <- XCMSList[[2]]

15: In `[<-`(`*tmp*`, "object", value = <S4 object of class structure("xcmsRaw", package = "xcms")>) :
  implicit list embedding of S4 objects is deprecated
50: In .local(object, ...) :
  getPeaks: Peak  m/z:159.030288696289-159.030479431152,  RT:0.1005535-8.49973is out of retention time range for this sample (/Users/laurahmelo/Desktop/MetabolomicsProjects/XCMS/EddyQE_NoBins_XCMS/7A_DCM.mzXML), using zero intensity value.
20: In .local(object, ...) :
  getPeaks: Peak  m/z:219.047256469727-219.047439575195,  RT:0.100326-7.678is out of retention time range for this sample (/Users/laurahmelo/Desktop/MetabolomicsProjects/XCMS/EddyQE_NoBins_XCMS/10A_DCM.mzXML), using zero intensity value.
